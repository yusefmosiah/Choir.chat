...
def render_markdown_to_html(request: Request, md_file_path: Path, page_title: str, is_landing_page: bool = False) -> HTMLResponse:
...
async def read_landing_page(request: Request):
    ...
    return render_markdown_to_html(request, md_path, "Welcome to Choir", is_landing_page=True)
